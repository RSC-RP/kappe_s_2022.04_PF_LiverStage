...
```{r}
fData(cb_eset) %>% 
  filter(gene_id %in% GO_annots_TF$gene_id) %>% 
  arrange(gene_name)
# GO_annots_TF 
```
...
svg("figures/motif_analysis/time_point_cluster_ortholog_heatmap_seqlogos_tileplot_rows.svg", height = 12, width=10)
...
# svg("figures/motif_analysis/time_point_profiles_ortholog_heatmap_seqlogos_tileplot_rows.svg", height = 8, width=8) 
...
# svg("figures/motif_analysis/time_point_profile_ortholog_TF_expn_heatmap_seqlogos_tileplot_rows.svg", height = 8, width=10)
# wdts <- c(0.75,0.6,0.75)
...
# svg("figures/motif_analysis/time_point_cluster_heatmap_seqlogos_tileplot_rows.svg", height = 12, width=12)
...
# svg("figures/motif_analysis/time_point_cluster_ap2_heatmap_seqlogos_tileplot_rows.svg", height = 12, width=12)
...
# svg("figures/motif_analysis/time_point_profile_heatmap_seqlogos_tileplot_rows.svg", height = 12, width=14)
profile_AP2_plots$time_cluster + profile_AP2_plots$motif_enr + 
...
# svg("figures/motif_analysis/time_point_profile_TFexpn_ap2_heatmap_seqlogos_tileplot_rows.svg", height = 12, width=12)
