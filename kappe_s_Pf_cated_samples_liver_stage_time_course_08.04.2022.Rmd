...
# svg("figures/combat_seq/barcode_plots/day2_vs_spz_ClusterProfiler_GO0006412_barcode.svg", height = 5, width = 10)
...
# svg("figures/combat_seq/barcode_plots/day2_vs_spz_ClusterProfiler_GO0044409_barcode.svg", height = 5, width = 10)
...
# svg("figures/combat_seq/bubble_plots/day2_vs_spz_ClusterProfiler_bubblePlot_barcode_Day2.svg", height = 7, width = 10)
d2_up + bc1 + 
  plot_layout(design = layout) 
# dev.off()

# svg("figures/combat_seq/bubble_plots/day2_vs_spz_ClusterProfiler_bubblePlot_barcode_SPZ.svg", height = 7, width = 10)
d2_down + bc2 + 
  plot_layout(design = layout) 
# dev.off()
```
...
```{r}
purrr::map(names(cluster_go), function(clust){
  df <- cluster_go_dfs %>% 
    ...
    # pdf(paste0("figures/combat_seq/bubble_plots/",clust,"_ClusterProfiler_bubblePlot.pdf"), height = 5, width = 8)
