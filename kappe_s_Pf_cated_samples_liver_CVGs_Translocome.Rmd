...
pexel_expn_threshold_1TPM <- pexel_summary_stats %>% 
  ...
  # select(aa_name, gene_name:gene_id, passed_threshold, 
  #        n_matches_canonical_RLEDQ:position_canonical_RLEDQ)
...
# write.csv(signalp_pexel_results, "cvgs_pexel_domains/pexel_motif_hits_150aa_signalP_hits_100aa_expression_TPM.csv", row.names = FALSE)
```
...
signal_p_ids <- signalp_gtf$gene_id
...
# svglite::svglite("figures/uncorrected/cvgs_pexel/pexel_signalP_expression_1TPM_venn.svg", height = 10, width = 10, fix_text_size=FALSE, system_fonts = list(sans = "Open Sans"))
